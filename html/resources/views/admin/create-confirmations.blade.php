                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" name="acc" class="form-control m-input" placeholder="Hotel & Rooms Details">
                                                        <span class="m-form__help">
                                            ...
                                            <div class="m-form__section">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" name="arrival" class="form-control m-input" placeholder="ARRIVAL Airport Transfer ">
                                                        <span class="m-form__help">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" name="departure" class="form-control m-input" placeholder="ARRIVAL Airport Transfer ">
                                                        <span class="m-form__help">
                                            ...
                                            <div class="m-form__section">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="number" name="amount" class="form-control m-input" placeholder="ARRIVAL Airport Transfer ">
                                                        <span class="m-form__help">
																		Example: 7720.65
                                                    </div>
                                                </div>
